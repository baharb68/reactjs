...
export default class Products extends Component {
    render() {
        return (
            <div className="product d-flex flex-row flex-wrap justify-content-around bg-white mt-5 w-100 b-shadow ">
                ...
                <div className="product-item d-flex flex-row align-items-center position-relative">
                    ...
                    <div className="last-item position-absolute"><img className="w-100" src={pm} alt=""/>
                    </div>
                </div>
