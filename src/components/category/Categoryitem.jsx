...
export default class Categoryitem extends Component {
    ...
    render() {
        return (
            <div className="category col-12 col-md-4 d-flex justify-content-center mt-5">
                ...
                <button className="categorybtn mr-auto text-white mt-4 position-absolute">{this.props.btntext}<img src={this.props.btnicon} alt="" className="mr-4"/></button>
            </div>
        )
    }
}
